...
get_expected_checksum() {
  ...
  case "$rust_target" in
    aarch64-apple-darwin)
      echo "0e4f24fa47f089ecfce64f47320b1fb116e8baa0c1f13d26b03d0561ba0ea96c"
      ;;
    x86_64-apple-darwin)
      echo "d1807817c1a82c5275dbc681f0149c630bfad7e47f904feabb2da0a87abd3c6a"
      ;;
    x86_64-pc-windows-msvc)
      echo "100d577c79611b16d9a46a992135aeffa5e78e47251c7c19797a4cad2eb00642"
      ;;
    x86_64-unknown-linux-musl)
      echo "a57533a8c97866d44aa0868f7c3c31cf5b14a75f9a4ba1b29606efb450d7ba35"
      ;;
    aarch64-unknown-linux-musl)
      echo "5c265257a87ebccfbffc79a09c1c60cae9f790060b1284e0f8ec6a78425b89b5"
      ;;
    x86_64-unknown-linux-gnu)
      echo "85294f1255489aec7b0b11bb4f49b4b2f247bc4c4516ab873b105e22bb8d5812"
      ;;
    aarch64-unknown-linux-gnu)
      echo "dec99f525b37a5d0dba949b648445393705346481a313806009c742c67cf1608"
      ;;
    *)
...
archive="$releases/download/v0.5.0/$crate-$pretty_target.$extension"
