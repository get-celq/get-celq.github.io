...
get_expected_checksum() {
  ...
  case "$rust_target" in
    aarch64-apple-darwin)
      echo "f72482f93f3fe605306efc9de965ed285cf1b1851b661c15dca469b2ec0a8fcd"
      ;;
    x86_64-apple-darwin)
      echo "3cd0e08ec56b7925f107af0dcf2b9957fbaf489f75d1bc92dea674ace1839b71"
      ;;
    x86_64-pc-windows-msvc)
      echo "2f24e451fafc754f9cd45e665b48fcf10eefb9c9938e2be14050a0ccd5f1aecf"
      ;;
    x86_64-unknown-linux-musl)
      echo "d817249297851145d26ab7ef8a9650d065368eb1e13db82aca72017ca43b3055"
      ;;
    aarch64-unknown-linux-musl)
      echo "fe9da39c894afe2412b045a9331ecd8c4cbba14485d475b4e0ec24353aa5b094"
      ;;
    x86_64-unknown-linux-gnu)
      echo "42cdfc4e0f81da0e2b223e9297fb1cf415c51fcdd53e82625d391801069ce2dc"
      ;;
    aarch64-unknown-linux-gnu)
      echo "6786931b0003273bb177aca70725da11994fe84231f64c8acee3200b19eff9b2"
      ;;
    *)
...
archive="$releases/download/v0.3.2/$crate-$pretty_target.$extension"
