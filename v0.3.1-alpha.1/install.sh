...
get_expected_checksum() {
  ...
  case "$rust_target" in
    aarch64-apple-darwin)
      echo "14e8a1ca6a2648208a8bb530cc9decffb2d3d5088e3ed6c49d0a2de63f4f9974"
      ;;
    x86_64-apple-darwin)
      echo "285407b67a2b4acd5750744c1280539d74751c52256f0367664a0f886c784a5f"
      ;;
    x86_64-pc-windows-msvc)
      echo "df531b2b7bc0aaa70efe6fd00ba437c6e67e14cd0c43bb2b1d542f969d66208f"
      ;;
    x86_64-unknown-linux-musl)
      echo "29bc7fe00e45cf28f5a4631b753bbb16d14458b4eb489972a7ed6f3f1ae21b87"
      ;;
    aarch64-unknown-linux-musl)
      echo "1e5e7fc2f845180e58d2da89fc9d89cdc59ec654b0adfb5199339b7632363093"
      ;;
    x86_64-unknown-linux-gnu)
      echo "c8d380352328ba4dcda0ad5cae6669c9ca5a0348c403be20f9ae1ec8cecc8027"
      ;;
    aarch64-unknown-linux-gnu)
      echo "9e604178b570050167f9764f006af8c32556943aa40ba3aa195919513732968c"
      ;;
    *)
...
archive="$releases/download/v0.3.1-alpha.1/$crate-$pretty_target.$extension"

say "Repository:  $url"
say "Crate:       $crate"
say "Tag:         v0.3.1-alpha.1"
say "Target:      $target"
