...
get_expected_checksum() {
  ...
  case "$rust_target" in
    aarch64-apple-darwin)
      echo "d1768458f82cca3f9311f9eed3927e243ddaf2e7b8304fc93af36b60f12e56a4"
      ;;
    x86_64-apple-darwin)
      echo "1f4b1e6e6f6b8bee112d523fcdbbccf97166536f4a2a9cb00dc32680ff83aef1"
      ;;
    x86_64-pc-windows-msvc)
      echo "6661c6e14a52599cb217d5989e8cdf794c25a0b7b0e998349ad874517f092b36"
      ;;
    x86_64-unknown-linux-musl)
      echo "20bd644fca3f38afd2c5700d0b7cf488e3d08730c206536640797703ed91afb5"
      ;;
    aarch64-unknown-linux-musl)
      echo "8c962a11dc0e38a5df28499058fc195a31601836e435458efe27e4d6bea49518"
      ;;
    x86_64-unknown-linux-gnu)
      echo "b7ebc80ab9e4a3307307396bc4458dbcb538ba5352abce84491740bbc1487712"
      ;;
    aarch64-unknown-linux-gnu)
      echo "6521b51c8361f6abf34bef9e88f853ba9e2ced42e2487dfe43751ea54d22eb6f"
      ;;
    riscv64gc-unknown-linux-musl)
      echo "f279d9f5423d205c1751b8fc9d60948f01f361a03dee6fd1bd957b004cfc5ddb"
      ;;
    riscv64gc-unknown-linux-gnu)
      echo "cb6fdd475ed783f20de3c7e0ce6da2b616036e76855f9eab2d59a390fa53e57d"
      ;;
    *)
...
archive="$releases/download/v0.6.0/$crate-$pretty_target.$extension"
