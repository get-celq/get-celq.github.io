...
get_expected_checksum() {
  ...
  case "$rust_target" in
    aarch64-apple-darwin)
      echo "606ff552e277e3d1ca477f63f3098b22ec4b8ce4843667cd5d3e770c9fcada7a"
      ;;
    x86_64-apple-darwin)
      echo "e2d217ae79ddba1b8f2086928a045ed224b49bebae53f0c8af26f1afe4762a02"
      ;;
    x86_64-pc-windows-msvc)
      echo "904770138c821b373473b3050708fcf7744d7b8926595dc8bfca0259d18a5370"
      ;;
    x86_64-unknown-linux-musl)
      echo "e870cea3d77f44c3fcab0bcdaf2a9b46eedfa5a08bb4202e3876f609bea1e878"
      ;;
    aarch64-unknown-linux-musl)
      echo "8f3794c2b3f653d4683181856a4dd36b6a270c83209588ac577f73e0a850dc32"
      ;;
    x86_64-unknown-linux-gnu)
      echo "7727d5a10efc832240e10c51559ba0c45720f8f717dabe0a9e34b8c99a9e95ae"
      ;;
    aarch64-unknown-linux-gnu)
      echo "8fa2969cb9840fc4c8fca6c6eaa37e00169893ccf3f005913038900db63a7d6b"
      ;;
    *)
...
archive="$releases/download/v0.3.1/$crate-$pretty_target.$extension"
