...
get_expected_checksum() {
  ...
  case "$rust_target" in
    aarch64-apple-darwin)
      echo "689bde5535f9a07ed722c8b472db527c1ab852974807b9f8bc290214ad89ba62"
      ;;
    x86_64-apple-darwin)
      echo "82df4258df9e811fe66b651d5b476bea3752c1fffe8a6c262460d5cdc543f88e"
      ;;
    x86_64-pc-windows-msvc)
      echo "c22e6b90ddc289b0d7e7ce445f3219d1f754857773ccbc075f8ee2e58c481ed4"
      ;;
    x86_64-unknown-linux-musl)
      echo "248a3c899f7cd5a57562bf6354c793830e135fb198307b803527423cdccb04ce"
      ;;
    aarch64-unknown-linux-musl)
      echo "d7f52471d399a9df8242b02a79cb744c46c301d7a436e66abfc16be267e670c6"
      ;;
    x86_64-unknown-linux-gnu)
      echo "d105c5c26204d3f32c48b5d03ef3418ee379b5338e84aafa11accafe963b5156"
      ;;
    aarch64-unknown-linux-gnu)
      echo "3696ef1140fd534e2614780ed239dd03604d6edfe77c675e429af8eb6b9b59a2"
      ;;
    *)
...
archive="$releases/download/v0.4.0/$crate-$pretty_target.$extension"
